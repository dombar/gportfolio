         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                  ...
                  <?php
                    if($verifica -> getRelatorio_indicadores()){
                        echo '<li><a href="../view/RelatorioIndicadores.php"><span class="glyphicon glyphicon-list-alt"></span> Relatório de Indicadores</a></li>';
                    }else{
                        echo '<li><a href="#"><span class="glyphicon glyphicon-list-alt"></span> Relatório de Indicadores</a></li>';
                    }
                  ?>
               </ul>
